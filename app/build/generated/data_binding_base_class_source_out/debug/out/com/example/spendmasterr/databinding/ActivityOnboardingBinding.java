...
public final class ActivityOnboardingBinding implements ViewBinding {
  ...
  private ActivityOnboardingBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnNext,
      @NonNull Button btnSkip, @NonNull TabLayout tabLayout, @NonNull ViewPager2 viewPager) {
  ...
  public static ActivityOnboardingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOnboardingBinding((ConstraintLayout) rootView, btnNext, btnSkip, tabLayout,
          viewPager);
    }
