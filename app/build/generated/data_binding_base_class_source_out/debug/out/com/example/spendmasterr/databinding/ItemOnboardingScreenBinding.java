...
public final class ItemOnboardingScreenBinding implements ViewBinding {
  @NonNull
  ...
  private ItemOnboardingScreenBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ItemOnboardingScreenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemOnboardingScreenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_onboarding_screen, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemOnboardingScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemOnboardingScreenBinding((ConstraintLayout) rootView, imageOnboarding,
