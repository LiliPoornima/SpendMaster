...
public final class FragmentAddTransactionBinding implements ViewBinding {
  ...
  private FragmentAddTransactionBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextInputEditText editTextTitle, @NonNull RadioButton radioExpense,
      @NonNull RadioGroup radioGroupType, @NonNull RadioButton radioIncome,
      @NonNull Spinner spinnerCategory, @NonNull TextInputLayout textInputLayoutAmount,
      @NonNull TextInputLayout textInputLayoutDate, @NonNull TextInputLayout textInputLayoutTitle,
    ...
    this.textInputLayoutDate = textInputLayoutDate;
  ...
  public static FragmentAddTransactionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.textInputLayoutDate;
      TextInputLayout textInputLayoutDate = ViewBindings.findChildViewById(rootView, id);
      if (textInputLayoutDate == null) {
        break missingId;
      }
      ...
      return new FragmentAddTransactionBinding((ConstraintLayout) rootView, buttonCancel,
          buttonSave, editTextAmount, editTextDate, editTextTitle, radioExpense, radioGroupType,
          radioIncome, spinnerCategory, textInputLayoutAmount, textInputLayoutDate,
          textInputLayoutTitle, textViewCategory, textViewType);
    }
